...
import static it.marcobiasone.test.util.OAuth2TestUtil.TEST_USER_LOGIN;
import static it.marcobiasone.test.util.OAuth2TestUtil.registerAuthenticationToken;
import static it.marcobiasone.test.util.OAuth2TestUtil.testAuthenticationToken;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.get;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import it.marcobiasone.IntegrationTest;
import it.marcobiasone.security.AuthoritiesConstants;
