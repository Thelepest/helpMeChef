...
class CommentResourceIT {
    ...
    public static Comment createEntity(EntityManager em) {
        Comment comment = new Comment().title(DEFAULT_TITLE).body(DEFAULT_BODY);
        return comment;
    }
    ...
    public static Comment createUpdatedEntity(EntityManager em) {
        Comment comment = new Comment().title(UPDATED_TITLE).body(UPDATED_BODY);
        return comment;
    }
    ...
    @Test
    @Transactional
    void getAllCommentsByTitleIsNotEqualToSomething() throws Exception {
        // Initialize the database
        commentRepository.saveAndFlush(comment);
    ...
    @Test
    @Transactional
    void getAllCommentsByRecipeIsEqualToSomething() throws Exception {
        // Initialize the database
        commentRepository.saveAndFlush(comment);
        Recipe recipe;
        ...
        // Get all the commentList where recipe equals to recipeId
        defaultCommentShouldBeFound("recipeId.equals=" + recipeId);

        // Get all the commentList where recipe equals to (recipeId + 1)
        defaultCommentShouldNotBeFound("recipeId.equals=" + (recipeId + 1));
    }
    ...
    void putNewComment() throws Exception {
        ...
        updatedComment.title(UPDATED_TITLE).body(UPDATED_BODY);
    ...
    void fullUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.title(UPDATED_TITLE).body(UPDATED_BODY);
