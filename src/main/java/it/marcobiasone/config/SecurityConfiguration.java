package it.marcobiasone.config;

import it.marcobiasone.security.*;
import it.marcobiasone.security.SecurityUtils;
import it.marcobiasone.security.oauth2.AudienceValidator;
import it.marcobiasone.security.oauth2.CustomClaimConverter;
import it.marcobiasone.security.oauth2.JwtGrantedAuthorityConverter;
import java.util.*;
