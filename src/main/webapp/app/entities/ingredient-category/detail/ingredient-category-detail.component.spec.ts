...
describe('IngredientCategory Management Detail Component', () => {
      ...
      providers: [
        {
          ...
          useValue: { data: of({ ingredientCategory: { id: 123 } }) },
        },
      ],
    })
      .overrideTemplate(IngredientCategoryDetailComponent, '')
      .compileComponents();
  ...
  describe('OnInit', () => {
    it('Should load ingredientCategory on init', () => {
      // WHEN
      comp.ngOnInit();

      // THEN
      expect(comp.ingredientCategory).toEqual(expect.objectContaining({ id: 123 }));
    });
  });
